                                ...
                                <form className="ui form">
                                        ...
                                        >
                                            <SocialMediaLinkedAccount
                                                linkedAccounts={this.state.profileData.linkedAccounts.linkedIn}
                                                gitAccounts={this.state.profileData.linkedAccounts.github}
                                        ...
                                        >
                                            <Language
                                                    ...
                                                    updateMessage={this.updateMSG} //new
                                                    //userinfo={this.state.userId} // new
                                        ...
                                        >
                                            <PhotoUpload
                                                imageData={this.state.profileData.profilePhoto}
                                                updateProfileData={this.updateAndSaveData}
